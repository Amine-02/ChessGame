...
//bool ChessBoard::isMoveResultingInCheckMate(const Position& from, const Position& to, const Position& kingPosition) {
//    
//    Position positionKing = findKing(currentPlayer_);
//    std::vector<std::pair<int, int>> allMoves;
//
//    allMoves.push_back(std::make_pair(positionKing.first + 1, positionKing.second));
//    allMoves.push_back(std::make_pair(positionKing.first + 1, positionKing.second - 1));
//    allMoves.push_back(std::make_pair(positionKing.first, positionKing.second - 1));
//    allMoves.push_back(std::make_pair(positionKing.first - 1, positionKing.second - 1));
//    allMoves.push_back(std::make_pair(positionKing.first - 1, positionKing.second));
//    allMoves.push_back(std::make_pair(positionKing.first - 1, positionKing.second + 1));
//    allMoves.push_back(std::make_pair(positionKing.first, positionKing.second + 1));
...
//        Position newPosition(move.first, move.second);
//        if (isValidPosition(newPosition)) {
//            if (!isMoveResultingInCheck(positionKing, newPosition, newPosition)) {
//                checkmate = false;
//                break;
//            }
//        }
